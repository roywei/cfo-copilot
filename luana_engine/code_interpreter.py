...
class CodeInterpreter:
    ...
    def run(self, code):
        ...
        if (
            self.print_cmd and self.language != "applescript"
        ):  # Applescript is special. Needs it to be a shell command because 'return' (very common) will actually return, halt script
